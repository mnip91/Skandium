...
public class GCMSkandiumBuilder {
	...
	public static Component build(String name) throws InstantiationException, NoSuchInterfaceException {
	    ...
	    ital.add(tf.createGCMItfType("scrr", GCMSResultReceiver.class.getName(), GCMTypeFactory.CLIENT, GCMTypeFactory.OPTIONAL, GCMTypeFactory.SINGLETON_CARDINALITY));
	    ...
	    ital.add(tf.createGCMItfType(GCMSConstants.WORKER_CLIENT_ITF, Worker.class.getName(), GCMTypeFactory.CLIENT, GCMTypeFactory.OPTIONAL, GCMTypeFactory.SINGLETON_CARDINALITY));
